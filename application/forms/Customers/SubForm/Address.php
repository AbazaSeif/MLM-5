...
/**
 * Customer Address subform
 *
 * @method CustomerAddress getModel() getModel()
 */
class Customers_SubForm_Address extends \Application\Form\Subform
{
	public function init()
	{
		...
		$element->setRequired()
			->setMultiOptions(array(
				\Model\CustomerAddress::BILLING_ADDRESS 		=> "do płatności",
				\Model\CustomerAddress::SHIPPING_ADDRESS 	=> "do wysyłki"
			))
			->setLabel("Typ adresu")
